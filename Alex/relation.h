...
struct Relation {
	...
	//Insert values into a row of a table TODO DONE
	void insert_row(vector<string> value_list);
	
	//Delete rows where attribute satisfies condition TODO DONE
	//cond_list contains the keys to the row that is going to be deleted
	void delete_row(vector<string> key_list);
	
	/*----------------- Column Operations ------------------*/

    //Insert values into a column of a table TODO DONE
	...
	//Select values in columns that satisfy conditions TODO DONE
	//cond_list contains name and then type
	vector<string> select_column(vector<string> cond_list);
	
	//Update values in columns that satisfy conditions TODO DONE
	//cond_list contains name and then type
